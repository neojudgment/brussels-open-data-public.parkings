...
WelcomeLabel2=Cet assistant va vous guider dans l'installation de [name/ver] sur votre ordinateur.%n%nLe Framework .NET 4.5.2 est un composant obligatoire pour le fonctionnement de Brussels Open Data - wifi.brussels.%n%nBrussels Open Data - wifi.brussels est fourni GRATUITEMENT. Si vous avez payé (autrement que par un don au developpeur de Brussels Open Data - wifi.brussels), nous vous recommendons d'obtenir un remboursement!
