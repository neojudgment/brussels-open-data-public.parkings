...
WelcomeLabel2=This will install [name/ver] on your computer.%n%n.NET Framework 4.6.2 is mandatory for brussels open data - wifi.brussels to run.%n%nbrussels open data - wifi.brussels is provided FREE OF CHARGE. If you paid for it (other than donate at the brussels open data - wifi.brussels developer) then whe recommend that you get a refund!
